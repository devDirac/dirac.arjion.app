...
import useCatalogoTipoConcepto from './useCatalogoTipoConcepto';
import { useIntl } from 'react-intl';
import './style.scss';

const CatalogoTipoConcepto: React.FC<CatalogoEspecialidadProps> = (props: CatalogoEspecialidadProps) => {
...
export default CatalogoTipoConcepto
