...
import { useCatalogosGenericos } from './useCatalogosGenericos';
import './style.scss';

const CatalogosGenericos: React.FC<CatalogosGenericosProps> = (props: CatalogosGenericosProps) => {
...
export default CatalogosGenericos;
