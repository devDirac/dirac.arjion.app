...
import useCatalogoTipoAcance from './useCatalogoTipoAcance';
import './style.scss';

const CatalogoTipoAcance: React.FC<CatalogoEspecialidadProps> = (props: CatalogoEspecialidadProps) => {
...
export default CatalogoTipoAcance
