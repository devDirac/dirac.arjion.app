...
import { useCatalogoTipoContrato } from './useCatalogoTipoContrato';
import './style.scss';

const CatalogoTipoContrato: React.FC<CatalogosGenericosProps> = (props: CatalogosGenericosProps) => {
          ...
          <Form.Group style={{ width: '100%' }}>
            <Grid item xs={12}>
              <InputField
                ...
                placeholder={intl.formatMessage({ id: 'input_clave' })}
                type="text"
                id="clave"
...
export default CatalogoTipoContrato
