...
import { InicioNewDashboardResponsablesInfoProps } from './types';
...
const InicioNewDashboardResponsablesInfo: React.FC<InicioNewDashboardResponsablesInfoProps> = (props: InicioNewDashboardResponsablesInfoProps) => {
   ...
   /*  const infoProyecto = useSelector((state: any) => state?.app?.new_dashboard?.infoProyecto || {});
    ...
    const handleOENE = async () => {
        try {
            setProcesando(true);
            const res: any = await getOENEHTTP(contrato?.id, responsable, contratosFiltro.toString());
    ...
    const handlePendientesContabilizar = async () => {
        try {
            setProcesando(true);
            const res: any = await getPendientesContabilizarResponsablesHTTP(contrato?.id,responsable, contratosFiltro.toString());
    ...
    const hanndleEstimacionesProceso = async () => {
        try {
            setProcesando(true);
            const res: any = await getEstimacionesProcesoResponsablesHTTP(contrato?.id,responsable, contratosFiltro.toString());
    ...
    const hanndleFondoGarantia = async () => {
        try {
            setProcesando(true);
            const res: any = await getFondoGarantiaResponsablesHTTP(contrato?.id,responsable, contratosFiltro.toString());
    ...
    const handleAnticipos = async () => {
        try {
            setProcesando(true);
            const res: any = await getAnticiposResponsablesHTTP(contrato?.id,responsable, contratosFiltro.toString());
        ...
        <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
                <Accordion style={{ backgroundColor: '#e9eef1', boxShadow: 'none', border: 'none' }} defaultExpanded>
                    ...
                    <AccordionDetails style={{ backgroundColor: darkMode ? '#28334a' : '#e9eef1' }}>
                        ...
                        <Grid container spacing={1} style={{ border: darkMode ? 'solid 2px white' : 'solid 2px #28334a', marginTop: 10, padding: 20 }}>
                            ...
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ borderTop: 'solid 2px #f26f3a' }}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'><strong>Total estimados:</strong></h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> {numericFormatter(totalEstimados + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })} </p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Deductivas:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter(deductivas + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ cursor: 'pointer' }} onClick={() => { hanndleFondoGarantia() }}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Fondo de garantia:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter(fondoGarantia + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                            ...
                            <Grid item md={4} sm={12} xl={4} xs={12} >
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Contabilizados:</strong> </h5> </Grid>
                                    <Grid xs={12} style={{ borderBottom: 'solid 2px #f26f3a' }}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((anticiposContabilizados + fondoGarantiaContabilizados + estimacionesContabilizados) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'><strong>Estimaciones:</strong>  {numericFormatter((estimacionesContabilizados) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'><strong>Anticipos:</strong>  {numericFormatter((anticiposContabilizados) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'><strong>Fondo de garantia:</strong>  {numericFormatter((fondoGarantiaContabilizados) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12}>
                                <Grid container>
                    ...
                    <AccordionDetails style={{ backgroundColor: darkMode ? '#28334a' : '#e9eef1' }}>
                        <Grid container spacing={1} style={{ border: darkMode ? 'solid 2px white' : 'solid 2px #28334a', marginTop: 10, padding: 20 }}>
                            <Grid item md={12} sm={12} xl={12} xs={12}>
                                ...
                                <p className='inicio-new-dashboard-sub-titulo' style={{ color: 'rgb(87, 110, 133)' }}><strong>% Avance anticipo + financiero {numericFormatter((props?.data?.porcentaje_anticipo_mas_financiero || 0) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, suffix: '%' })}</strong> <Progreso avance={props?.data?.porcentaje_anticipo_mas_financiero} color='rgb(132 130 177)' /></p>
                            </Grid>
                        </Grid>
                    </AccordionDetails>
                </Accordion>
                ...
                <Accordion style={{ backgroundColor: '#e9eef1', boxShadow: 'none', border: 'none' }}>
                    ...
                    <AccordionDetails style={{ backgroundColor: darkMode ? '#28334a' : '#e9eef1' }}>
                        <Grid container spacing={1} style={{ border: darkMode ? 'solid 2px white' : 'solid 2px #28334a', marginTop: 10, padding: 20 }}>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ borderTop: 'solid 2px #1c75bc', marginTop: 20 }}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#1c75bc' }} className='inicio-new-dashboard-sub-titulo'> <strong>Contratado Pesos:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#1c75bc' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((contratadoPesos) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })} </p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ marginTop: 20 }}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#1c75bc' }} className='inicio-new-dashboard-sub-titulo'><strong>Contratado Dolares:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#1c75bc' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((contratadoDolares) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })} </p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ marginTop: 20 }}>
                                <Grid container>
                            ...
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{ borderTop: 'solid 2px #f26f3a' }}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Estimado Pesos:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((estimadoPesos) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{}}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Estimado Dolares:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((estimadoDolares) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                            <Grid item md={4} sm={12} xl={4} xs={12} style={{}}>
                                <Grid container>
                                    <Grid xs={12}> <h5 style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'> <strong>Estimado Euros:</strong> </h5> </Grid>
                                    <Grid xs={12}> <p style={{ color: '#f26f3a' }} className='inicio-new-dashboard-sub-titulo'>{numericFormatter((estimadoEuros) + '', { thousandSeparator: ',', decimalScale: 2, fixedDecimalScale: true, prefix: '$' })}</p> </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
                    </AccordionDetails>
...
export default InicioNewDashboardResponsablesInfo;