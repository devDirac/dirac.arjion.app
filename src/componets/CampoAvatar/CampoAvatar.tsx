    ...
    return (
        ...
        <Stack direction="row" spacing={2}>
            <StyledBadge
                ...
                badgeContent={
                    <EditIcon fontSize='large' style={{ cursor: 'pointer' }} onClick={handleEditPictureProfile} />
                }
            >
            ...
            <input onChange={(e) => {
                ...
                ref={reference} type="file" id="file-selector" accept=".jpg, .jpeg, .png" style={{ visibility: 'hidden' }} />
