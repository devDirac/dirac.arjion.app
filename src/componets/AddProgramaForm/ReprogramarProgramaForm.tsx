...
export interface ReprogramarProgramaFormProps {
    procesando: boolean
...
const ReprogramarProgramaForm: React.FC<ReprogramarProgramaFormProps> = (props: ReprogramarProgramaFormProps) => {
                        ...
                        <Form.Group className="mb-3 ">
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={12}>
                                    ...
                                    >
                                        {intl.formatMessage({ id: "general_reprogramar" })}
                                    </Button>
                                </Grid>
                            </Grid>
                        </Form.Group>
...
export default ReprogramarProgramaForm
