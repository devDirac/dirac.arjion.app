...
import type { AddNotaFrenteFormProps } from './AddNotaFrenteFormTypes'
...
import useAddNotaFrenteForm from './useAddNotaFrenteForm';

const AddNotaFrenteForm: React.FC<AddNotaFrenteFormProps> = (props: AddNotaFrenteFormProps) => {
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} md={12}>
                                    <SelectField
                                        ...
                                        value={tipo_nota}
                                        options={catalogoTipoNota.filter((e: any) => e?.nombre === 'Nota').map((r: any) => {
                                            return {
                                                value: r?.id,
                                                label: r?.nombre || ''
                                            }
...
export default AddNotaFrenteForm
