...
import useAltaMasivaFrentes from './useAltaMasivaFrentes'

const AltaMasivaFrentes: React.FC<AltaMasivaFrentesProps> = (props: AltaMasivaFrentesProps) => {

    const {
        darkMode,
        handleArchivo,
        reference
    } = useAltaMasivaFrentes(props);
...
export default AltaMasivaFrentes
