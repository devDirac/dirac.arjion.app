import './style.scss'
import { ConfirmaConceptosExtraordinariosFormsPasoDosProps } from './types'
...
const ConfirmaConceptosExtraordinariosFormsPasoDos: React.FC<ConfirmaConceptosExtraordinariosFormsPasoDosProps> = (props: ConfirmaConceptosExtraordinariosFormsPasoDosProps) => {
  const intl = useIntl();
...
export default ConfirmaConceptosExtraordinariosFormsPasoDos